...
public class ARolePagingUtilCrqfc {
	...
	public ARolePagingUtilCrqfc(int totalCount, int crqfcCurrentPage, HttpServletRequest request) {
		super();
	...
	public ARolePagingUtilCrqfc(int totalCount, int crqfcCurrentPage, HttpServletRequest request, int blockCount, int blockPage, String empl_id) {
		super();
		this.totalCount = totalCount;
		this.crqfcCurrentPage = crqfcCurrentPage;
		this.request = request;
...
//		    this.pageHtmls.append("<li class='page-item'><a class='page-link' onclick='changeCrqfcPage(" + prev_page + ")' aria-label='Previous'><span aria-hidden='true'>« Prev</span><span class='sr-only'>Previous</span></a></li>");
		    this.pageHtmls.append("<li class='page-item'><a class='page-link' href='"+ requestURI+"?"+params+ "crqfcCurrentPage="+(this.crqfcCurrentPage-1) +"&empl_id=" + empl_id + "' aria-label='Previous'><span aria-hidden='true'>« Prev</span><span class='sr-only'>Previous</span></a></li>");
		}
...
//				this.pageHtmls.append("<li class='page-item'><a class='page-link' onclick='changeCrqfcPage(" + i + ")'>" + i + "</a></li>");
				this.pageHtmls.append("<li class='page-item'><a class='page-link' href='" + requestURI + "?" + params + "crqfcCurrentPage=" + i + "&empl_id=" + empl_id + "'>" + i + "</a></li>");
			}
		}
...
//			this.pageHtmls.append("<li class='page-item'><a class='page-link' onclick='changeCrqfcPage(" + next_page + ")' aria-label='Next'><span aria-hidden='true'>Next »</span><span class='sr-only'>Next</span></a></li>");
			this.pageHtmls.append("<li class='page-item'><a class='page-link' href='" + requestURI + "?" + params + "crqfcCurrentPage=" + (this.crqfcCurrentPage + 1) + "&empl_id=" + empl_id + "' aria-label='Next'><span aria-hidden='true'>Next »</span><span class='sr-only'>Next</span></a></li>");
		}else{
