...
public class RolePagingUtil {
	...
	public RolePagingUtil(int totalCount, int currentPage, HttpServletRequest request) {
		super();
	...
	public RolePagingUtil(int totalCount, int currentPage, HttpServletRequest request, int blockCount, int blockPage) {
		super();
		this.totalCount = totalCount;
		this.currentPage = currentPage;
		this.request = request;
...
//		}
		...
		if((this.currentPage-1)==0){
		    ...
		    this.pageHtmls.append("<li class='page-item'><a class='page-link' href='"+ requestURI+"?"+params+ "currentPage="+(this.currentPage-1) +"' aria-label='Previous'><span aria-hidden='true'>« Prev</span><span class='sr-only'>Previous</span></a></li>");
		}
		...
		if(this.currentPage < this.totalPage){
			this.pageHtmls.append("<li class='page-item'><a class='page-link' href='" + requestURI + "?" + params + "currentPage=" + (this.currentPage + 1) + "' aria-label='Next'><span aria-hidden='true'>Next »</span><span class='sr-only'>Next</span></a></li>");
		}else{
