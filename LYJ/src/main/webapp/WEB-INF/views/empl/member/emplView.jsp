...
$(function(){
	$('#empl_nm').val('${LOGIN_EMPLINFO.empl_nm}');
	if('${LOGIN_EMPLINFO.empl_sexdstn}' == 'm') $('#male').prop('checked', true);
	else $('#female').prop('checked', true);
	$('#empl_hp').val('${LOGIN_EMPLINFO.empl_hp}');
	$('#empl_mail').val('${LOGIN_EMPLINFO.empl_mail}');
	$('#empl_zip').val('${LOGIN_EMPLINFO.empl_zip}');
	$('#empl_add1').val('${LOGIN_EMPLINFO.empl_add1}');
	$('#empl_add2').val('${LOGIN_EMPLINFO.empl_add2}');
	$('#empl_dept').val('${LOGIN_EMPLINFO.empl_dept}');
	$('#empl_ofcps').val('${LOGIN_EMPLINFO.empl_ofcps}');
	$('#empl_level').val('${LOGIN_EMPLINFO.empl_level}');
	$('#empl_bir').val('${LOGIN_EMPLINFO.empl_bir}');
	$('#empl_ecny').val('${LOGIN_EMPLINFO.empl_ecny}');
	...
	$('#btnUpdateEmpl').click(function(){
		...
		$('#frmEmplView').attr('action', '${pageContext.request.contextPath}/empl/member/updateEmpl.do');
		$('#frmEmplView').submit();
	});
	...
	$('#btnInsertPrjctHist').click(function(){
		...
		$frmPrjctHist = $('<form action="${pageContext.request.contextPath}/empl/member/insertPrjctHist.do" method="post"/>');
	...
	$('#tblPrjctHist tr:gt(0)').click(function(){
		$.ajax({
			...
			url : '${pageContext.request.contextPath}/empl/member/prjctHistView.do',
	...
	$('#btnDeletePrjctHist').click(function(){
		...
		location.href = "${pageContext.request.contextPath}/empl/member/deletePrjctHist.do?prjct_hist_id=" + prjct_hist_id;
	});
	
	$('#btnInsertCrqfcHold').click(function(){
		var crqfc_hold_crqfc = $('#crqfc_nm').val();
		location.href = "${pageContext.request.contextPath}/empl/member/insertCrqfcHold.do?crqfc_hold_crqfc=" + crqfc_hold_crqfc;
	});
	...
	$('#btnDeleteCrqfcHold').click(function(){
		...
		location.href = "${pageContext.request.contextPath}/empl/member/deleteCrqfcHold.do?crqfc_hold_empl=" + crqfc_hold_empl + "&crqfc_hold_crqfc=" + crqfc_hold_crqfc;
	});
});
</script>
</head>
	                ...
	                <div class="media profil-cover-details w-100">
	                    <div class="media-left pl-2 pt-2">
	                        <a href="#" class="profile-image">
	                            <img src="/empl/file/${LOGIN_EMPLINFO.empl_photo}" class="rounded-circle img-border height-100" alt="Card image">
	                        </a>
	                    </div>
																...
																<div class="modal-body">
																	...
																	<div class="form-group position-relative has-icon-left">
																		...
																		<div class="form-control-position">
																			<i class="fa fa-envelope font-medium-5 line-height-1 text-muted icon-align" style="margin-top: 33px"></i>
																		</div>
																	</div>
																	<div class="form-group position-relative has-icon-left">
