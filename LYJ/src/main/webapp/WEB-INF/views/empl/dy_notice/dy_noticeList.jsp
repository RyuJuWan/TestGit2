...
$(function(){
   $('#btnForm').click(function(){
      location.href = '${pageContext.request.contextPath}/empl/dy_notice/noticeForm.do?prjct_id='+'${prjct_id}';
   });
   
   $('table tr:gt(0)').click(function(){
	   var dynm_notice_id = $(this).find('td:eq(0) input').val();
	   $(location).attr('href', '${pageContext.request.contextPath}/empl/dy_notice/noticeView.do?dynm_notice_id=' + dynm_notice_id+ '&prjct_id=${prjct_id}');
   });
});
</script>
</head>
