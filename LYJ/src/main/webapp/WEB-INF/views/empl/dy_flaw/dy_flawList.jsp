...
$(function(){
	   $('#createFlaw').click(function(){
		  location.href = '${pageContext.request.contextPath}/empl/dy_flaw/dy_flawForm.do?prjct_id=${prjct_id}'; 
	   });
	   
	   $('#flawListTable tr:gt(0)').click(function(){
		   if(eval('${empty sessionScope.LOGIN_EMPLINFO.empl_id}')){
			   alert("로그인이 필요합니다.");
			   return false;
		   } else{
			   var flaw_id = $(this).find('input[name=flaw_id]').val();
			   location.href = '${pageContext.request.contextPath}/empl/dy_flaw/dy_flawView.do?flaw_id=' + flaw_id +'&prjct_id=${prjct_id}';
		   }
	   });
	});
</script>
        ...
        <div class="card">
            <div class="card-header">
        		...
        		<div class="heading-elements">
            		<button id="createFlaw" class="btn btn-primary btn-sm"><i class="ft-plus white"></i> 결함 Add</button>
                </div>
            </div>
            <div class="card-content">
                <div class="card-body">
	                ...
	                <div class="table-responsive">
		                ...
		                <div class="row">
		                <div class="col-sm-12">
		                <table id="flawListTable" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle dataTable" role="grid" aria-describedby="project-task-list_info" style="position: relative;">
					         <thead>
					            <tr>
					                <th>발생 일자</th>
					                <th>결함명</th>
