...
<body>
    ...
    <form id="frmWeekReprtForm" class="form-horizontal" action="${pageContext.request.contextPath}/empl/dy_reprt/insertDy_weekReprt.do?prjct_id=${prjct_id}" method="post" enctype="multipart/form-data">
		<div style="width: 3150px" align="left">
			<section id="horizontal-form-layouts">
				<div class="col-md-6" >
					<div class="card">
						<div class="card-header">
							<h4 class="card-title" id="basic-layout-colored-form-control">주간보고서 작성</h4>
