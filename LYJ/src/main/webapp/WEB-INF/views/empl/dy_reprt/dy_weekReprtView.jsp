...
$(function(){
	...
	$('#deleteFileName').click(function(){
		...
		return false;
		$('#frmWeekReprtView').submit(function(){});
	});
	
	$('#btnWeekReprtList').click(function(){
		location.href = '${pageContext.request.contextPath}/empl/dy_reprt/dy_weekReprtList.do?prjct_id=${prjct_id}';
	});
	
	$('#btnDeleteWeekReprt').click(function(){
		var reprt_id = $('#reprt_id').val();
		location.href = '${pageContext.request.contextPath}/empl/dy_reprt/deleteWeekReprt.do?prjct_id=${prjct_id}&reprt_id=' + reprt_id;
	});
});
</script>
</head>
<body>
    ...
    <form id="frmWeekReprtView" class="form-horizontal" action="${pageContext.request.contextPath}/empl/dy_reprt/updateDy_weekReprt.do?prjct_id=${prjct_id}" method="post" enctype="multipart/form-data">
		<div style="width: 3150px" align="left">
			<section id="horizontal-form-layouts">
				<div class="col-md-6" >
					<div class="card">
						<div class="card-header">
							<h4 class="card-title" id="basic-layout-colored-form-control">주간보고서 조회</h4>
								...
								<form class="form">
									...
									<c:if test="${emplInfo.empl_id eq reprtInfo.reprt_empl}">
				                        <div class="form-actions right">
					                        <button type="button" id="btnDeleteWeekReprt" class="btn btn-warning mr-1"><i class="ft-x"></i> 삭제</button>
											<button type="submit" class="btn btn-primary"><i class="fa fa-check-square-o"></i> 수정</button>
											<button type="button" id="btnWeekReprtList" class="btn btn-danger btn-min-width mr-1 mb-1" style="float: left" value="목록"><i class="fa fa-eye">목록</i></button>
										</div>
									</c:if>	
	                        	</div>
	                        </form>
