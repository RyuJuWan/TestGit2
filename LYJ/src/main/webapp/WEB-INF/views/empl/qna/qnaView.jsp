...
$(function(){
	$('#btnList').click(function(){
		location.href = '${pageContext.request.contextPath}/empl/qna/qnaList.do';
	});
	...
	var qna_id='${qnaInfo.qna_id}';
	
	$('#deletebtn').click(function(){
		location.href = '${pageContext.request.contextPath}/empl/qna/deleteQnaInfo.do?qna_id=${qnaInfo.qna_id}';
	});
});
</script>
</head>
...
<form action="${pageContext.request.contextPath }/empl/qna/modifyQnaInfo.do" class="form-horizontal">
	            ...
	            <div class="card-content collpase show">
	                <div class="card-body">
	                    ...
	                    <form class="form form-horizontal">
	                        ...
	                        <input type="hidden" name="qna_id" id="qna_id" value="${qnaInfo.qna_id }">
