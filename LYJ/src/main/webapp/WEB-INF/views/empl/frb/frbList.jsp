...
$(function(){
   $('#btnForm').click(function(){
      location.href = '${pageContext.request.contextPath}/empl/frb/frbForm.do';
   });
   
   $('table tr:gt(0)').click(function(){
	   var frb_id = $(this).find('td:eq(0) input').val();
	   $(location).attr('href', '${pageContext.request.contextPath}/empl/frb/frbView.do?frb_id='+frb_id);
   })
});
</script>
</head>
            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                          <form action="/empl/frb/frbList.do" method="post" class="form-inline pull-right" >
