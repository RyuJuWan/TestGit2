...
$(function(){
   $('#btnForm').click(function(){
      location.href = '${pageContext.request.contextPath}/empl/notice/noticeForm.do';
   });
   
   $('table tr:gt(0)').click(function(){
	   var notice_id = $(this).find('td:eq(0) input').val();
	   $(location).attr('href', '${pageContext.request.contextPath}/empl/notice/noticeView.do?notice_id=' + notice_id);
   });
});
</script>
</head>
