...
$(function(){
	CKEDITOR.instances.ckeditor.setData('${wbsInfo.wbs_work_cn}');
...
<body> <div class="content-body">
    <form id="riskView" class="form-horizontal" method="post" action="${pageContext.request.contextPath}/empl/dy_wbs/dy_wbsUpdate.do">
		<div style="width: 3150px" align="left">
			<section id="horizontal-form-layouts">
				<div class="col-md-6" >
					<div class="card">
						<div class="card-header">
							<h4 class="card-title" id="basic-layout-colored-form-control">업무관리게시글 조회</h4>
	                    	...
	                    	<div class="form-body">
			                    ...
			                    <div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                            	...
		                            	<input type="text" id="wbs_work_nm" class="form-control" placeholder="First Name" name="wbs_work_nm" value="${wbsInfo.wbs_work_nm}">
		                            </div>
		                        </div>
		                        <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput1">일감 등록자</label>
		                            <div class="col-md-9">
		                            	<input type="text" id="wbs_strt_empl" class="form-control" placeholder="First Name" name="wbs_strt_empl" value="${wbsInfo.wbs_strt_empl}">
		                            </div>
		                        </div>
		                        ...
		                        <div class="form-group row">
									...
									<div class="col-md-9">
	                            		...
	                            		<input type="text" id="prjct_nm" class="form-control" placeholder="Last Name" name="prjct_nm" value="${prjct_nm}" disabled="disabled">
	                            	</div>
		                        </div>
...
<!-- 		                        </div> -->
		                        ...
		                        <div class="form-group row">
		                        	...
		                        	<div class="col-md-9">
		                        		<input type="date" id="wbs_compt" class="form-control" name="wbs_compt" value="${fn:substring(requestScope.wbsInfo.getWbs_compt(), 0, 10)}">
		                            </div>
		                        </div>
		                        ...
		                        <div class="form-group row">
		                        	...
		                        	<div class="col-md-9">
			                            <input type="date" id="wbs_date" class="form-control" name="wbs_date" value="${fn:substring(requestScope.wbsInfo.wbs_date, 0, 10)}">
		                            </div>
		                        </div>
