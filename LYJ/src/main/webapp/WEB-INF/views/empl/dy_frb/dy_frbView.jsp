...
<script type="text/javascript">
	$(function() {
		$('#btnList')
				.click(
						function() {
							location.href = '${pageContext.request.contextPath}/empl/dy_frb/dy_frbList.do?prjct_id='+'${prjct_id}';
						});
		CKEDITOR.instances.ckeditor.setData('${dyFrInfo.dynm_frb_cn}');
		...
		var dynm_frb_id = '${dyFrInfo.dynm_frb_id}';

		$('#deletebtn')
				.click(
						function() {
							location.href = '${pageContext.request.contextPath}/empl/dy_frb/deleteFrbInfo.do?dynm_frb_id='
									+ dynm_frb_id;
						});
		
		$('#replyBtn').click(function(){
			var answer_cn= $('#answer_cn').val();
			location.href='${pageContext.request.contextPath }/empl/dy_frb/insertAnswer.do?dynm_frb_id=${dyFrInfo.dynm_frb_id}&answer_cn='+answer_cn;
		});
	});
</script>
</head>
<body>
	...
	<form
		action="${pageContext.request.contextPath }/empl/dy_frb/modifyFrbInfo.do"
										...
										<div class="form-group row">
											...
											<div class="col-md-9">
												<input type="text" id="dynm_frb_nm" class="form-control"
													placeholder="First Name" name="dynm_frb_nm" style="width: 900px"
													value="${dyFrInfo.dynm_frb_nm }">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-9">
												<input type="text" id="dynm_frb_id" class="form-control"
													placeholder="Company Name" name="dynm_frb_id"
													style="width: 600px" value="${dyFrInfo.dynm_frb_id }">
											</div>
										</div>
											...
											<div class="card-content collapse show">
												<div class="card-body">
													<div class="form-group">
														<textarea id="ckeditor" name="dynm_frb_cn" cols="30" rows="15"
															class="ckeditor">
											</textarea>
													</div>
												</div>
									...
									<div class="card-content">
										<div class="card-body">
											<div class="media-list media-bordered">
												...
												<c:if test="${answInfo.answer_grp eq dyFrInfo.dynm_frb_id}">
													<div class="media">
	...
	<%-- 															<a href="${pageContext.request.contextPath }/empl/dy_frb/modifyAnswInfo.do?answer_grp=${dyFrInfo.dynm_frb_id}"> <i class="ft-edit mr-0"></i> Edit</a> --%>
	 															<a href="${pageContext.request.contextPath }/empl/dy_frb/deleteAnswerInfo.do?answer_id=${answInfo.answer_id}&dynm_frb_id=${dyFrInfo.dynm_frb_id}"> <i class="ft-edit mr-0"></i> Delete</a> 
															</c:if>
															</div>
														</div>
													</div>
														...
														<div class="row" style="margin-bottom: 0px;">
															<div class="col-md-11">
																<div class="form-group">
																	...
																	<div class="media-notation mt-1">
<%-- 																		<a href="${pageContext.request.contextPath }/empl/dy_frb/insertAnswer.do?dynm_frb_id=${dyFrInfo.dynm_frb_id}&answer_cn=$('#maxLength-textarea').val()"> <i class="ft-corner-up-left mr-0"></i>Reply</a> --%>
