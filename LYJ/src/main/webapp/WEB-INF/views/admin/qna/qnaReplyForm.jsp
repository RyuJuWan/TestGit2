...
$(function(){
	...
	$('#qnaReplyForm').submit(function(){
		$(this).attr('action', '${pageContext.request.contextPath }/admin/qna/insertReplyQna.do?qna_id=${qna_id}');
	       return true;
	});
});
</script>
	            ...
	            <div class="card-content collpase show">
	                <div class="card-body">
	                    ...
	                    <form class="form form-horizontal">
							...
							<input type="hidden" name="qna_grp" value="${qna_id }" >
	                        <input type="hidden" name="qna_seq" value="0">
	                        <input type="hidden" name="qna_dep" value="0">
	                        <input type="hidden" name="qna_delete" value="y">
	                        <input type="hidden" name="qna_empl" value="admin">
