...
$(function(){
	$('#btnList').click(function(){
		location.href = '${pageContext.request.contextPath}/admin/frb/frbList.do';
	});
	...
	$('#deletebtn').click(function(){
		location.href='${pageContext.request.contextPath}/admin/frb/deleteFrbInfo.do?frb_id=${frbInfo.frb_id}';
	});
	
	$('#replyBtn').click(function(){
		var answer_cn= $('#answer_cn').val();
		location.href='${pageContext.request.contextPath }/admin/frb/insertAnswer.do?frb_id=${frbInfo.frb_id}&answer_cn='+answer_cn;
	});
});
</script>
</head>
...
<form action="${pageContext.request.contextPath }/admin/frb/modifyFrbInfo.do" class="form-horizontal">
...
<section id="horizontal-form-layouts">
													...
													<c:forEach items="${emplList}" var="emplInfo">
														<c:if test="${emplInfo.empl_id eq answInfo.answer_empl}">
															<span class="media-left"> <img
																...
																src="/admin/file/prpsl/${emplInfo.empl_photo }"
	...
	<%-- 															<a href="${pageContext.request.contextPath }/admin/dy_frb/modifyAnswInfo.do?answer_grp=${dyFrInfo.dynm_frb_id}"> <i class="ft-edit mr-0"></i> Edit</a> --%>
	 															<a href="${pageContext.request.contextPath }/admin/frb/deleteAnswerInfo.do?answer_id=${answInfo.answer_id}&frb_id=${frbInfo.frb_id}"> <i class="ft-edit mr-0"></i> Delete</a> 
															</c:if>
															</div>
														</div>
													</div>
														...
														<div class="row" style="margin-bottom: 0px;">
															<div class="col-md-11">
																<div class="form-group">
																	...
																	<div class="media-notation mt-1">
<%-- 																		<a href="${pageContext.request.contextPath }/admin/frb/insertAnswer.do?dynm_frb_id=${dyFrInfo.dynm_frb_id}&answer_cn=$('#maxLength-textarea').val()"> <i class="ft-corner-up-left mr-0"></i>Reply</a> --%>
