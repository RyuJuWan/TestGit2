...
<script type="text/javascript">
	setInterval(function() {
		var empl_id = "${LOGIN_EMPLINFO.empl_id}";
		$.ajax({
			type : 'POST',
			dataType : 'JSON',
			data : {
			...
			url : "${pageContext.request.contextPath}/empl/messageChk.do",
			error : function(result) {
				alert("가져오기 실패");
			},
			success : function(result) {
				$('#wbsCount').text(result.wbsCount2);
				$('#issCount').text(result.issCount2);
			}
		})
	}, 300000000);
</script>
...
<body>
	<!-- fixed-top-->
	<nav
		class="header-navbar navbar-expand-md navbar navbar-with-menu fixed-top navbar-light navbar-hide-on-scroll navbar-border navbar-shadow navbar-brand-center">
		...
		<div class="navbar-header">
			<ul class="nav navbar-nav flex-row">
				...
				<li class="nav-item"><a class="navbar-brand"
					href="${pageContext.request.contextPath}/empl/main.do"><img
						class="brand-logo" alt="robust admin logo"
						src="../../../app-assets/images/logo/logo-dark-sm.png">
						<h3 class="brand-text">Remind</h3></a></li>
				...
				<ul class="nav navbar-nav mr-auto float-left">
					...
					<li class="dropdown nav-item mega-dropdown"><a
						...
						<ul class="mega-dropdown-menu dropdown-menu row">
									...
									<li class="menu-list">
										<ul>
											<li><a class="dropdown-item"
												href="layout-2-columns.html"><i class="ft-file"></i>
													Page layouts & Templates</a></li>
											<li><a href="#"><i class="ft-align-left"></i> Multi
													level menu</a>
												<ul>
													<li><a class="dropdown-item" href="#"><i
															class="fa fa-file-o"></i> Second level</a></li>
													<li><a href="#"><i class="fa fa-star-o"></i>
															Second level menu</a>
														<ul>
															<li><a class="dropdown-item" href="#"><i
													...
													<li><a class="dropdown-item" href="#"><i
															class="fa fa-film"></i> Second level, third link</a></li>
													<li><a class="dropdown-item" href="#"><i
															class="fa fa-envelope-o"></i> Second level, fourth link</a></li>
												</ul></li>
											<li><a class="dropdown-item"
												href="color-palette-primary.html"><i class="ft-camera"></i>
													Color palette system</a></li>
											<li><a class="dropdown-item"
												href="../../../starter-kit/ltr/vertical-menu-template/layout-2-columns.html"><i
													class="ft-edit"></i> Page starter kit</a></li>
											<li><a class="dropdown-item" href="changelog.html"><i
													class="ft-minimize-2"></i> Change log</a></li>
											<li><a class="dropdown-item"
												href="https://pixinvent.ticksy.com/"><i
													class="fa fa-life-ring"></i> Customer support center</a></li>
										</ul>
									</li>
								</ul>
							</li>
							<li class="col-md-3">
								<h6 class="dropdown-menu-header text-uppercase">
									<i class="fa fa-list"></i> Accordion
								</h6>
									...
									<div
										...
										<div class="card-header p-0 pb-2 border-0" id="headingTwo"
											...
											<a class="collapsed" data-toggle="collapse"
												...
												aria-expanded="false" aria-controls="accordionTwo">Accordion
												Item #2</a>
										</div>
										<div class="card-collapse collapse" id="accordionTwo"
											role="tabpanel" aria-labelledby="headingTwo"
											aria-expanded="false">
											<div class="card-content">
												<p class="accordion-text">Sugar plum bear claw oat cake
													chocolate jelly tiramisu dessert pie. Tiramisu macaroon
													muffin jelly marshmallow cake. Pastry oat cake chupa chups.</p>
											</div>
										</div>
										...
										<div class="card-collapse collapse" id="accordionThree"
											role="tabpanel" aria-labelledby="headingThree"
											aria-expanded="false">
											<div class="card-content">
												<p class="accordion-text">Candy cupcake sugar plum oat
													cake wafer marzipan jujubes lollipop macaroon. Cake dragée
													jujubes donut chocolate bar chocolate cake cupcake
													chocolate topping.</p>
											</div>
										</div>
									</div>
				...
				<ul class="nav navbar-nav float-right">
					...
					<li class="dropdown dropdown-notification nav-item"><a
						...
						<ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
							...
							<a href="${pageContext.request.contextPath}/empl/dy_wbs/dy_wbsList.do">
									<div class="media">
										...
										<div class="media-body">
											...
											<span
												class="notification-tag badge badge-default badge-danger float-right m-0" id="wbsCount">${sessionScope.wbsCount}
												New</span> <small><time class="media-meta text-muted"
													datetime="2015-06-11T18:29:20+08:00">30 minutes ago</time></small>
										</div>
									</div>
							</a>
<%-- 							 <a href="${pageContext.request.contextPath}/empl/dy_issue/dy_issueList.do"> --%>
							 <a href="#">
									<div class="media">
										<div class="media-left align-self-center">
											<i
										...
										<div class="media-body">
											...
											<span
												class="notification-tag badge badge-default badge-danger float-right m-0" id="issCount">${sessionScope.issCount}
												New</span>
					...
					<li class="dropdown dropdown-notification nav-item"><a
						class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i
							...
							class="badge badge-pill badge-default badge-info badge-default badge-up">5
						</span></a>
						<ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
							<li class="dropdown-menu-header">
								<h6 class="dropdown-header m-0">
					...
					<li class="dropdown dropdown-user nav-item"><a
						...
						data-toggle="dropdown"><span class="avatar avatar-online"><img
								...
								alt="avatar"><i></i></span><span class="user-name">${LOGIN_EMPLINFO.empl_nm}</span></a>
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item"
								href="${pageContext.request.contextPath}/empl/member/emplView.do"><i
							...
							<a class="dropdown-item"
								href="${pageContext.request.contextPath}/empl/join/logout.do"><i
