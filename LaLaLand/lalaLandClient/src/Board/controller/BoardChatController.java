...
public class BoardChatController {
	...
	void hover(MouseEvent event) {
		Image imgg = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/봇1.png");
		img.setImage(imgg);
	}

	@FXML
	void hoverOut(MouseEvent event) {
		Image imgg = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/채팅.jpg");
		img.setImage(imgg);
