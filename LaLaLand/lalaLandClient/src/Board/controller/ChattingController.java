...
public class ChattingController implements Initializable {
	...
	Image img_bot = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/봇.PNG");
	Image img_mem;
	...
	public void setting() {
		...
		if(file.exists()) {
			...
			URL = "file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/image/noimage.jpg";
			
		}
		
		img_mem=new Image(URL);
		hbox.setVisible(true);
		ta_admin.setText("라라랜드입니다 \n 무엇을 도와드릴까요?");
