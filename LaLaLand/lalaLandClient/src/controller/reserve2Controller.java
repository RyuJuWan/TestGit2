...
public class reserve2Controller {
    ...
    void hover(MouseEvent event) {
    	Image img = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/envelope1.png") ;
    	img_reserve.setImage(img);
    }

    @FXML
    void hoverOut(MouseEvent event) {
    	Image img = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/envelope.png") ;
    	img_reserve.setImage(img);
    }
