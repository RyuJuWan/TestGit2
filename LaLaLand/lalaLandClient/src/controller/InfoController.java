...
public class InfoController{
    ...
    void hover(MouseEvent event) {
    	Image img = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/fecebook1.png") ;
    	facebook_img.setImage(img);
    }

    @FXML
    void hover1(MouseEvent event) {
    	Image img = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/instagram1.png") ;
    ...
    void hoverOut(MouseEvent event) {
    	Image img = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/facebook.png") ;
    	facebook_img.setImage(img);
    }

    @FXML
    void hoverOut1(MouseEvent event) {
    	Image img = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/instagram.png") ;
    	instagram_img.setImage(img);
    ...
    void click_download(MouseEvent event) {
    	try {
			FileInputStream fin = new FileInputStream("C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/data/guidebook.pdf");
