    ...
    void hoverrOut(MouseEvent event) {
	  ...
	  @FXML
	    void hover(MouseEvent event) {
		  Image img = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/img1.png");
		  img1.setImage(img);
	    }

	    @FXML
	    void hover2(MouseEvent event) {
	    	Image img = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/img2.png");
			  img2.setImage(img);
	    }

	    @FXML
	    void hoverOut(MouseEvent event) {
	    	Image img = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/로봇Event.PNG");
			  img1.setImage(img);
	    }

	    @FXML
	    void hoverOut2(MouseEvent event) {
	    	Image img = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/faceEvent.PNG");
			  img2.setImage(img);
	    }
	@FXML
...
//			stage.setScene(scene);
	...
	void initialize() {
		...
		Image img = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/회전목마1.gif");
...
//	            System.out.println("지역 : " + jsonObj.get("name"));
			...
			if (weather.equals("\"Clear\"")) {
				String URL = "file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/image/해.png";
				Image img = new Image(URL);
				tmp_picture.setImage(img);
			} else if (weather.equals("\"Fog\"")) {
				String URL = "file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/image/흐림.png";
				Image img = new Image(URL);
				tmp_picture.setImage(img);
				...
				String URL = "file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/image/비.png";
				Image img = new Image(URL);
				tmp_picture.setImage(img);

			} else if (weather.equals("\"Snow\"")) {
				String URL = "file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/image/눈.png";
				Image img = new Image(URL);
				tmp_picture.setImage(img);
