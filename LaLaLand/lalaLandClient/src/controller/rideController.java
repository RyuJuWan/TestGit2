...
public class rideController {
    ...
    void hover(MouseEvent event) {
    	Image img = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/맵1.png") ;
    ...
    void hoverOut(MouseEvent event) {
    	Image img = new Image("file:///C:/ddit_all/A_TeachingMaterial/4.MiddleProject/workspace/lalaLandClient/Image/맵.png") ;
    	img_map1.setImage(img);
    }
